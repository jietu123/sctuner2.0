...
def _build() -> None:
    ...
    vis_root = root / "visualizations" / "simulations" / "human_lung_5loc"
    out = vis_root / "human_lung_5loc_triptych_stack_3rows.png"
    ...
    truth_csv = root / "data" / "sim" / "human_lung_5loc" / "human_lung_5loc_fine9_clustered_sim" / "sim_truth_spot_type_fraction.csv"
    ...
    title = "Human Lung 5-Location Mapping Comparison"
    tb = draw.textbbox((0, 0), title, font=title_font)
